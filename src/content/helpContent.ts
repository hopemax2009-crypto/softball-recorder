    ...
    sections: [
      {
        ...
        items: [
          ...
          { text: '點擊比賽卡片進入紀錄；若顯示「未排先發」，請先到紀錄頁「棒次」排定打序。' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '「棒次」分頁：點擊 1–16 棒選擇球員（不可重複）。' },
          { text: '「守位」分頁：點擊守位從已排棒次球員中指派（不可重複）。' },
          { text: '紀錄分頁打序每頁顯示 4 棒（目前棒次+下 3 棒），可翻頁瀏覽全隊。' },
    ...
    sections: [
      {
        title: '基本操作',
        items: [
          { text: '切換「賽季成績」或「累計成績」，點球員卡片查看詳細統計與雷達圖。' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '雷達圖', text: '打擊率、上壘率、幸運值、長打爆發力、惡運值五維能力。' },
        ],
      },
    ],
  },
